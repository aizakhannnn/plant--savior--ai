...
$filePath = "c:\Users\hp\Documents\GitHub\plant--savior--ai\streamlit_app.py"
...
$replacements = @{
    ...
    </div>' = '<div class="glass-container border">
    ...
    'st.markdown(''<div class="glass-container fade-in-up" style="padding: 3rem; border: 1px solid rgba(0, 245, 255, 0.3);">'', unsafe_allow_html=True)
        st.markdown(''<h2 class="section-title" style="font-size: 2rem; margin-bottom: 2rem;">IDENTITY VERIFICATION</h2>'', unsafe_allow_html=True)' = 'st.markdown(''<div class="login-container">'', unsafe_allow_html=True)'

    '👤 OPERATOR ID' = 'Operator ID'
    '🔑 ACCESS CODE' = 'Access Code'
    '🚀 INITIATE SYSTEM' = 'Initiate System'
    
    '<div class="step-card">
        <div class="step-number">1</div>
        <div class="step-icon">📱</div>
        <h3 class="step-title">IMAGE CAPTURE</h3>' = '<div class="step-card">
        <div class="step-number">1</div>
    ...
    '<div class="step-card">
        ...
        <div class="step-icon">🧠</div>
        <h3 class="step-title">AI PROCESSING</h3>' = '<div class="step-card">
        <div class="step-number">2</div>
    ...
    '<div class="step-card">
        ...
        <div class="step-icon">📊</div>
        <h3 class="step-title">INSTANT DIAGNOSIS</h3>' = '<div class="step-card">
        <div class="step-number">3</div>
    ...
    '🧠 AI PROCESSING IMAGE...' = 'AI PROCESSING IMAGE...'
    '🔍 DETECTING PATTERNS...' = 'DETECTING PATTERNS...'
    '📊 GENERATING DIAGNOSIS...' = 'GENERATING DIAGNOSIS...'
    ...
    'span style="background: linear-gradient(90deg, #00ff88, #00cc66); color: white; padding: 0.5rem 2rem; border-radius: 25px; font-weight: bold; font-size: 1.1rem;"' = 'span style="background-color: #dcfce7; color: #166534; padding: 0.5rem 1.5rem; border-radius: 9999px; font-weight: 600; font-size: 0.875rem;"'
    'span style="background: linear-gradient(90deg, #ff6b35, #ff2d95); color: white; padding: 0.5rem 2rem; border-radius: 25px; font-weight: bold; font-size: 1.1rem;"' = 'span style="background-color: #fee2e2; color: #991b1b; padding: 0.5rem 1.5rem; border-radius: 9999px; font-weight: 600; font-size: 0.875rem;"'
}

$enumerator = $replacements.GetEnumerator()
while ($enumerator.MoveNext()) {
    $content = $content.Replace($enumerator.Name, $enumerator.Value)
}

[System.IO.File]::WriteAllText($filePath, $content)
Write-Output "UI Updated!"
